package de.tuberlin.sgd.core.old.v1;
 ...
 * {LBJ2.learn.StochasticGradientDescent.Parameters Parameters} as
 ...
 * {LBJ2.learn.StochasticGradientDescent.Parameters Parameters} class
...
public class StochasticGradientDescent extends Learner
{
     ...
     * settings in the {@link StochasticGradientDescent._Parameters} object.
     *
     * @param p  The settings of all parameters.
     **/
    public StochasticGradientDescent(_Parameters p) { this("", p); }
     ...
     * @param p  The settings of all parameters.
     **/
    public StochasticGradientDescent(String n, _Parameters p)
    {
        super(n);
     ...
     * @author Nick Rizzolo
     **/
    public static class _Parameters extends Parameters
    {
        /**
